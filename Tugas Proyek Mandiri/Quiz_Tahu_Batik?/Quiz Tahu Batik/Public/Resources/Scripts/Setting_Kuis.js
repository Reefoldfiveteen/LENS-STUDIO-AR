...
function refreshQuestions(){
    ...
    if (questionNumber < Math.min(myQuestions.length,script.maxQuestions)){
        ...
        script.scoreText.text = "Pertanyaan: " + quest + "/" + Math.min(myQuestions.length,script.maxQuestions)

    } else {
		script.finalQuestionTitle.text = "Dalam " + title
        script.finalScore.text = "Skor Kamu adalah: \n" + correctAnswers + "/" + Math.min(myQuestions.length,script.maxQuestions)
